...
const ProductList = () => {
    ...
    const decreasQuantity = (item) => {
        console.log(item, " decreasQuantity");
        const newCart = [...products]
        let productInCart = newCart.find(tempProduct =>
            item.name === tempProduct.name);
    ...
    return (
        <Routes>
            ...
            <Route path="/cart" element={<Cart products={products} increaseQuantity={increaseQuantity} decreasQuantity={decreasQuantity} deleteItem={deleteItem} clearCart={clearCart} />} />
        </Routes>
    )
}
